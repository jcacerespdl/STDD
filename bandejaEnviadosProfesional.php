...
$sql = "
    ...
    WHERE m.iCodTrabajadorRegistro = ?
";
...
if ($filtroOficina !== '') {
    // Nota: esto filtra por oficina DESTINO del movimiento
...
foreach ($tramites as $t) {
    if (!in_array($t['iCodTramite'], $vistos, true)) {
        $tramitesUnicos[] = $t;
        $vistos[] = $t['iCodTramite'];
    }
}
...
<div class="container" style="margin: 120px auto; max-width: 1500px; background: white; border: 1px solid #ccc; border-radius: 10px; padding: 30px;">
    <div class="titulo-principal">BANDEJA DE ENVIADOS PROFESIONAL</div>
    ...
    <div style="flex: 1;">
        ...
        <label><input type="checkbox" name="enviado_no"> Por Aprobar</label>
            ...
            <div class="row" style="justify-content: flex-end; gap: 10px;">
                ...
                <button type="button" class="btn btn-secondary" onclick="window.location.href='BandejaEnviadosProfesional.php'">

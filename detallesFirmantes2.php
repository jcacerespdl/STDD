...
// Normalizar a null si viene como texto "null" o vacío
if ($iCodDigital === "null" || $iCodDigital === "") {
    $iCodDigital = null;
}

if (!$iCodTramite) {
    echo "<p>Parámetros insuficientes.</p>";
    exit;
}
...
if (is_null($iCodDigital)) {
    ...
    $sql = "SELECT f.iCodFirma, f.posicion, f.tipoFirma, f.nFlgFirma, 
            ...
            WHERE f.iCodTramite = ? AND f.iCodDigital IS NULL";

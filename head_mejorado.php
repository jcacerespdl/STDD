...
<body>
  ...
  <header class="header-bar">
    <div class="header-left">
      <img src="img/cabecera.jpeg" alt="Logo Horizontal"> 
      <span class="system-title">Sistema de Gestión Documental</span>
    </div>
  ...
  <nav class="navbar">
    ...
    <div class="submenu">
        <?php if ($_SESSION['iCodPerfilLogin'] == 2): ?>
            <a href="mesadepartes.php" class="submenu-item">Ingreso Mesa de Partes Físico</a>
        <?php else: ?>
        ...
        <?php endif; ?>
            ...
            <div class="nav-item">BANDEJA
                <div class="submenu">
                    <?php if ($_SESSION['iCodPerfilLogin'] == 2): ?>
                    <a href="bandejaMesaDePartes.php" class="submenu-item">Bandeja Mesa de Partes Virtual</a>
                    <?php endif; ?>
                    <?php if (in_array($_SESSION['iCodPerfilLogin'], [2, 3, 19])): ?>
                    <a href="BandejaPendientes.php" class="submenu-item"> Pendientes (<?= $pendientes ?>)</a>
                    <?php endif; ?>
                    ...
                    <a href="bandejaPorAprobar.php" class="submenu-item"> Documentos por Aprobar (<?= $porAprobar ?>)</a>
                    
                    <?php endif; ?>
                    
                    <a href="BandejaFirma.php" class="submenu-item"> Documentos para Firma (<?= $paraFirma ?>)</a>

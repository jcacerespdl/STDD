...
$sqlDelegado = "SELECT TOP 1 tm.iCodTrabajadorDelegado
    FROM Tra_M_Tramite_Movimientos tm
    JOIN Tra_M_Tramite_Movimientos origen ON tm.iCodMovimiento = origen.iCodMovimientoDerivo
    WHERE tm.iCodOficinaDerivar = ?
    AND origen.iCodMovimiento = ?
    AND tm.iCodTrabajadorDelegado IS NOT NULL";

$paramsDelegado = [$mov['iCodOficinaDerivar'], $mov['iCodMovimientoDerivo']];
$stmtDelegado = sqlsrv_query($cnx, $sqlDelegado, $paramsDelegado);
